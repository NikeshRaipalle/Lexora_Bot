...
class LanguageModel():
    ...
    def get_response_from_GPT3(self, chat_history):
        ...
        """
        # Mock responses for testing when quota is exceeded
        mock_responses = [
            "Hello! How can I help you practice your language skills today?",
            "That's great! Can you tell me more about that?",
            "I understand. What would you like to practice next?",
            "Excellent! Your language skills are improving.",
            "Let's try a different topic. What interests you?"
        ]
